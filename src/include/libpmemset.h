...
int pmemset_source_from_external(struct pmemset_source **src,
...
int pmemset_source_from_file_paramsU(struct pmemset_source **src,
		const wchar_t *file);

int pmemset_source_from_file_paramsW(struct pmemset_source **src,
		const wchar_t *file);
...
int pmemset_source_fallocate(struct pmemset_source *src, int flags,
