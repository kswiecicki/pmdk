...
/*
 * test_part_map_firt - get the first (earliest in the memory)
		...
		char *argv[])
{
	...
	pmem2_map = pmemset_part_map_get_pmem2_map(first_pmap);
	UT_ASSERTeq(pmem2_map_get_size(pmem2_map), part_size);
