	...
	int argc, char *argv[])
{
	...
	/*
	 * The offset increases by half of the file size. Starting from
	 * offset '0', there are 2 * n_files - 1 offsets that will fit in the
	 * reservation region.
	 */
	size_t offset_inc = size / 2;
